...
def print_html_header():
    ...
    profile_file.write("<style>\n")
    profile_file.write("div.gallery {\n")
    profile_file.write("  margin: 5px;\n")
    profile_file.write("  border: 1px solid #ccc;\n")
    profile_file.write("  float: left;\n")
    profile_file.write("  width: 320px\n")
    profile_file.write("}\n")
    profile_file.write("\ndiv.gallery img {\n")
    profile_file.write("  width: 100%;\n")
    profile_file.write("  heightL auto;\n")
    profile_file.write("}\n\n")
    profile_file.write("div.desc {\n")
    profile_file.write("  padding: 15px\n")
    profile_file.write("  text-align: center;\n")
    profile_file.write("}\n")
    profile_file.write("</style>\n")
    profile_file.write("</head>\n")
    profile_file.write("<body>\n")
    profile_file.write("<div>\n")
    profile_file.write("<h1>")
    imgstr = '<img src="' + instance.username.lower() + '.jpg">'
    profile_file.write(imgstr)
...
def print_html():
    ...
    profile_filename = instance.username + "/" + instance.username + "_index.html"
...
class Instaloader:
    ...
    def update_comments(self, filename: str, post: Post) -> None:
        ...
        comment_file_path = filename + '_comments.html'
        date_str =  filename 
        ...
        if comments:
            ...
            instance.comment_file = comment_file_path
    ...
    def download_profilepic(self, profile: Profile, _attempt: int = 1) -> None:
        ...
        if ((format_string_contains_key(self.dirname_pattern, 'profile') or
            ...
            #filename = '{0}/{1}_profile_pic.{2}'.format(self.dirname_pattern.format(profile=profile.username.lower(),
             ...
             filename = profile.username.lower() + "/" + profile.username.lower() + "." + profile_pic_extension
        else:
    ...
    def download_profiles(self, profiles: Set[Profile],
        ...
        # TJB here is where we download the profile
